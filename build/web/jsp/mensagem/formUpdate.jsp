...
<div class="container" style="min-height:700px;">
    <mtw:form action="MensagemUpdate.mtw" id="formMensagem" method="post">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Atualizar mensagem</h3>
            </div>
            <!-- DADOS PESSOAIS -->
            <div class="panel-body" >
                <fieldset>
                    ...
                    <div class="col-xs-12 col-md-12" style="padding-bottom: 15px;">
                        ...
                        <br/>
                        <textarea class="form-control" rows="15" resize="none" id="descricao" name="descricao">${mensagem.descricao}</textarea>
                    </div>
                </fieldset>
            </div>
        </div>
...
<script>
    ...
    function validaForm() {
        if($("#descricao").val() == ""){
            ...
            $("#formMensagem").attr("action","/SYPweb/MensagemUpdate.mtw");
            $("#formMensagem").submit();
        }
    }
